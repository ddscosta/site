...
function getresult(){
   ...
   return rm.innerText+rc.innerText+_rd.innerText+_ru.innerText+"";
...
function exibir(){
   ...
   exibe.innerText = 
      ...
      rm.innerText+rc.innerText+_rd.innerText+_ru.innerText;
...
function rumais() {
   ...
   var conts = vm.innerText+vc.innerText+_vd.innerText+_ru.innerText;
